                ...
                <div class="col-sm-12">
                    <div class="form-group " >
                        ...
                        <div class="form-inline " >
                            <input name="quantity" type="text" class="form-control col-sm-7" placeholder="500" required>
                            <select name="measuring_unit" class="form-control col-sm-3"  style="margin-left: 5px;" required  placeholder="select unit of measurement">
