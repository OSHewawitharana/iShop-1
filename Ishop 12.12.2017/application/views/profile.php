...
<nav class="navbar navbar-inverse" style="background: #343a40!important; ">
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="myNavbar">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li><a href="<?php echo base_url('Login/LoginUser'); ?>">Login</a></li>
                <li><a href="<?php echo base_url('profileController/insertData'); ?>">Register Now!</a></li>
            </ul>
        </div>
    </div>
</nav>
...
<div class="footer-bottom" style="background: #343a40!important">
