...
foreach ($items as $record) {
	$table .= '<tr>
				<td style = "border:1px solid black">'.$record->shop_item_id.'</td>
				
				<td style = "border:1px solid black">'.$record->price.'</td>
				<td style = "border:1px solid black">'.$record->quantity.'</td>
				<td style = "border:1px solid black">'.$record->category.'</td>
				</tr>';
}
