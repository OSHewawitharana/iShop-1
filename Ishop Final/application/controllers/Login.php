	...
	function LoginUser()
  {
    ...
    if ($this->form_validation->run() == FALSE){
      ...
      $this->load->view('Login');
        ...
        $result3 = $this->Model_user->LoginUser1();
        ...
        if ($result != FALSE) {
          ...
          $this->session->set_flashdata('errmsg','Sorry, your request is pending. Please try again later.');
            redirect('Home/Login');
          ...
          $this->session->set_flashdata('errmsg','Email and the Password does not match!!!');
            redirect('Home/Login');
