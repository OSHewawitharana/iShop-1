                ...
                <div class="card wizard-card" data-color="blue" id="wizardProfile">
                    ...
                    <div class="tab-content">
                            ...
                            <div class="col-sm-10 col-sm-offset-1">
                                <div class="picture-container">
                                    <div class="picture">
                                        ...
                                        <input type="file" name="file_name" id="wizard-picture">
                                    </div>
                        ...
                        <div class="tab-pane" id="personalDetails">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label for="fullname"><span class="required" style="color: red">*</span>Full Name:</label>
                                    <input type="text" class="form-control" id="fullname" name="fullname" required>
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label for="NIC"><span class="required" style="color: red">*</span>NIC:</label>
                                    <input type="text" class="form-control" id="NIC" name="NIC" required>
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label for="contactNumber "><span class="required" style="color: red">*</span>Contact Number</label>
                        ...
                        <div class="tab-pane" id="shopDetails">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label for="shopName"><span class="required" style="color: red">*</span>Shop Name:</label>
                                    <input type="text" class="form-control" id="shopName" name="shopName" required>
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label for="shopCategory"><span class="required" style="color: red">*</span>Shop Category:</label>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label for="contactNumber "><span class="required" style="color: red">*</span>Telephone Number</label>
